...
export function timeOfDayToText(displayMinutes: number, useAmPm = true) {
	...
	const text = AM_PM_OUTPUT_TEMPLATE.format(displayHours === 0 ? 12 : displayHours, displayMinutes % 60, amPm);
